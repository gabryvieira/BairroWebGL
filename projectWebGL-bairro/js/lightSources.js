...
lightSources[2].setIntensity( 1.0, 1.0, 1.0 ); // luz do foco

lightSources[2].setAmbIntensity( 0.0, 0.0, 0.2 );

lightSources[2].switchRotYYOn();

//lightSources[2].switchRotXXOn(); // adicionado  luz branca a rodar nos eixos y e x conforme o enunciado

//lightSources[2].switchRotZZOn();
lightSources.push( new LightSource() );

lightSources[3].setPosition( 0.0, 10.0, 0.0, 4.0 );

lightSources[3].setIntensity( 1.0, 1.0, 0.0 ); // luz do foco
